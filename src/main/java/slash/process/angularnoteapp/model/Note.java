package slash.process.angularnoteapp.model;
...
public class Note {
    ...
    public NoteViewModel noteModel (){
        NoteViewModel noteViewModel=new NoteViewModel(this.id.toString(),this.title,this.text,this.notebook.getId().toString(),this.lastModifiedOn);
